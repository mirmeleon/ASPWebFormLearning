...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label8" runat="server" Text="Delivery Date"></asp:Label>
        <asp:Label ID="DeliveryDate" runat="server" Text=""></asp:Label> <br/>
        <asp:Label ID="Label10" runat="server" Text="Part Number"></asp:Label>
        <asp:Label ID="PartNumber" runat="server" Text=""></asp:Label> <br/>
          <asp:Label ID="Label3" runat="server" Text="Rush Order"></asp:Label>
